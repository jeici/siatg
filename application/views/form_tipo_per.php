...
echo form_open('persona/recuperar_persona',$atributos); //en este caso datosenviados contiene la url que hace el action
...
<div>SELECCIONE EL TIPO DE PERSONA A MODIFICAR</div>
