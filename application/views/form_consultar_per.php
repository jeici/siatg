...
$atributos = array('id'=> 'form_enviar', 'class' => 'enviar_form','href' => 'persona/consultar_persona');
 ...
 <?php }?>
        <div class="grid_12">
            ...
            <div class="grid_12" id="body">
                ...
                <div class="grid_2" id="editar"><?php echo form_open("persona/modificar_per",$atributos);?><?php echo form_hidden('id', $fila->carnet); echo form_hidden('tipo',$tipo);?> <?php echo form_close();?></div>
            </div>
            <?php
            endforeach;
            ?>
