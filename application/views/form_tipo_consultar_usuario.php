...
echo form_open('usuario/consultar_usuario',$atributos); //en este caso datosenviados contiene la url que hace el action
...
<div>SELECCIONE EL TIPO DE USUARIO A CONSULTAR</div>
