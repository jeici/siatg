  ...
  <h2>LISTA DE TRABAJOS</h2>
        ...
        <div class="grid_14">
            ...
            <div class="grid_12" id="body">
                ...
                <div class="grid_1" id="editar"><?php echo form_open("trabajograduacion/modificar_tg");?><input type="submit" value="Modificar" id="<?=$fila->id_trabajog?>" class="editar"><?php echo form_hidden('id', $fila->id_trabajog);?><?php echo form_close();?></div>
            </div>
            <?php
            endforeach;
            ?>
