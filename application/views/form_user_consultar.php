...
$atributos = array('id'=> 'form_enviar', 'class' => 'enviar_form','href' => 'usuario/consultar_user');
 ...
 <?php }?>
        <div class="grid_12">
            ...
            <div class="grid_12" id="body">
                ...
                <div class="grid_2" id="editar"><?php echo form_open("usuario/modificar_user",$atributos);?><?php echo form_hidden('id', $fila->id_usuario); echo form_hidden('tipo',$tipo);?> <?php echo form_close();?></div>
            </div>
            <?php
            endforeach;
            ?>
